...
func _on_computador_body_entered(body):
	if body.is_in_group("jogador"):
		_Text()
		queue_text("Sistama [versão 10.0.22000.1219]\n(c) Sistema Cpp. Todos os direitos reservados.\n \nC: /Users/use> Olá Mundo!!!\nC: /Users/use> Triangulo + Livros + Soma dos Romanos = * * * *\nC: /Users/use> Boa Sorte !!!")
